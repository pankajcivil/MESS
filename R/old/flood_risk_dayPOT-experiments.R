...
#=====================
# regret distribution comparisons
#=====================

pdf(paste(plot.dir,'regret_distributions.pdf',sep=''),width=4,height=7,colormodel='cmyk')
par(mfrow=c(4,1), mai=c(.55,.55,.2,.2))
hist(Reg$gpd137$gpd3,breaks=10000, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(Reg$gpd137$gpd4,breaks=10000, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(Reg$gpd137$gpd5,breaks=10000, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(Reg$gpd137$gpd6,breaks=10000, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
dev.off()

#=====================
# cross-model regret distribution comparisons
#=====================
pdf(paste(plot.dir,'crossmodel_regret_distributions.pdf',sep=''),width=7,height=7,colormodel='cmyk')
par(mfrow=c(4,4), mai=c(.55,.55,.2,.2))
mtext('Assumed model structure', side=2, line=2, cex=1, adj=5)

# if you use gpd3, but gpdX was correct...
hist(RegX$gpd137$gpd3$gpd3, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd3$gpd4, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd3$gpd5, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd3$gpd6, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
# if you use gpd4, but gpdX was correct...
hist(RegX$gpd137$gpd4$gpd3, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd4$gpd4, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd4$gpd5, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd4$gpd6, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
# if you use gpd5, but gpdX was correct...
hist(RegX$gpd137$gpd5$gpd3, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd5$gpd4, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd5$gpd5, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd5$gpd6, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
# if you use gpd6, but gpdX was correct...
hist(RegX$gpd137$gpd6$gpd3, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd6$gpd4, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd6$gpd5, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
hist(RegX$gpd137$gpd6$gpd6, breaks=n.ensemble$gpd3, xlim=c(0,500), ylim=c(0,20), main='', xlab='Regret [million euro]')
dev.off()
