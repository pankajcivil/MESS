...
processing_delfzijl(dt.decluster=.dt.decluster, detrend.method='annual', pot.threshold=.pot.threshold)

# Norfolk, Virgina, United State
source('processing_norfolk.R')
processing_norfolk(dt.decluster=.dt.decluster, detrend.method='annual', pot.threshold=.pot.threshold)

# Balboa, Panama
source('processing_balboa.R')
processing_balboa(dt.decluster=.dt.decluster, detrend.method='annual', pot.threshold=.pot.threshold)
